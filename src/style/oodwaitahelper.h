...
#ifndef OODWAITA_HELPER_H
#define OODWAITA_HELPER_H
...
{
/*
 * Oodwaita style helper class.
 * contains utility functions used at multiple places in both oodwaita style and oodwaita window decoration
 */
class Helper
{
public:
