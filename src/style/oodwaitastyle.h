...
#ifndef OODWAITA_STYLE_H
#define OODWAITA_STYLE_H

#include "oodwaita.h"
#include "config-oodwaita.h"
...
private:
    ...
    //* tabbar data
    OodwaitaPrivate::TabBarData *_tabBarData;
    ...
    ColorVariant _variant { Oodwaita };
