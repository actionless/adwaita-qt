...
#ifndef OODWAITA_COLORS_P_H
#define OODWAITA_COLORS_P_H
...
public:
    ...
    Q_ENUM(OodwaitaColor);

    ColorsPrivate();
    virtual ~ColorsPrivate();

    QColor oodwaitaColor(OodwaitaColor color, ColorVariant variant);
    QColor oodwaitaWidgetColor(const QString &color, ColorVariant variant);
    static bool isDarkMode();

private:
    QHash<OodwaitaColor, QHash<ColorVariant, QColor> > m_colors;
    QHash<QString, QMap<ColorVariant, QColor> > m_widgetColors;
};

} // namespace Oodwaita

#endif // OODWAITA_COLORS_P_H
