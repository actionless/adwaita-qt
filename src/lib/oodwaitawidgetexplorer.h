...
#ifndef OODWAITA_WIDGET_EXPLORER_H
#define OODWAITA_WIDGET_EXPLORER_H
...
class OODWAITAQT_EXPORT WidgetExplorer : public QObject
{
    Q_OBJECT
public:
    //* constructor
...
#endif // OODWAITA_WIDGET_EXPLORER_H
