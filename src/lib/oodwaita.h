...
namespace PropertyNames
{
    ...
    const char menuTitle[] = "_oodwaita_toolButton_menutitle";
    const char alteredBackground[] = "_oodwaita_altered_background";
}
...
enum ColorVariant { Unknown, Oodwaita, OodwaitaDark, OodwaitaHighcontrast, OodwaitaHighcontrastInverse };

class StyleOptionsPrivate;

class OODWAITAQT_MAIN_EXPORT StyleOptions
{
public:
...
Q_DECLARE_OPERATORS_FOR_FLAGS(Oodwaita::AnimationModes)
Q_DECLARE_OPERATORS_FOR_FLAGS(Oodwaita::Corners)
Q_DECLARE_OPERATORS_FOR_FLAGS(Oodwaita::Sides)
