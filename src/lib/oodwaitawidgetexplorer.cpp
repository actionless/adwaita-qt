...
Q_LOGGING_CATEGORY(OODWAITA, "oodwaita.widgetexplorer")
...
//             if( !type.isEmpty() )
//             {
//                 QTextStream( stdout ) << "Oodwaita::WidgetExplorer::eventFilter - widget: " << object << " (" << object->metaObject()->className() << ")";
...
//         }
    ...
    case QEvent::MouseButtonPress: {
        ...
        qCDebug(OODWAITA)
                << "Oodwaita::WidgetExplorer::eventFilter -"
