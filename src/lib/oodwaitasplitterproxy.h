...
#ifndef OODWAITA_SPLITTER_PROXY_H
#define OODWAITA_SPLITTER_PROXY_H

#include "oodwaita.h"
#include "oodwaitaaddeventfilter.h"
...
//* factory
class OODWAITAQT_EXPORT SplitterFactory : public QObject
{
    Q_OBJECT
...
#endif // OODWAITA_SPLITTER_PROXY_H
