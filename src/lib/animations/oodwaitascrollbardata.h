...
#ifndef OODWAITA_SCROLLBAR_DATA_H
#define OODWAITA_SCROLLBAR_DATA_H
...
{
//* scrollbar data
class OODWAITAQT_EXPORT ScrollBarData : public WidgetStateData
{
    Q_OBJECT
...
#endif // OODWAITA_SCROLLBAR_DATA_H
