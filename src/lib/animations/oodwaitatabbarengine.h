...
#ifndef OODWAITA_TABBAR_ENGINE_H
#define OODWAITA_TABBAR_ENGINE_H

#include "oodwaita.h"
#include "oodwaitabaseengine.h"
#include "oodwaitadatamap.h"
#include "oodwaitatabbardata.h"
#include "oodwaitaqt_export.h"

namespace Oodwaita
{
//* stores tabbar hovered action and timeLine
class OODWAITAQT_EXPORT TabBarEngine : public BaseEngine
{
    Q_OBJECT
public:
    //* constructor
...
#endif // OODWAITA_TABBAR_ENGINE_H
