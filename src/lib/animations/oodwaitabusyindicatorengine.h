...
#ifndef OODWAITA_BUSY_INDICATOR_ENGINE_H
#define OODWAITA_BUSY_INDICATOR_ENGINE_H

#include "oodwaitaanimation.h"
#include "oodwaitabaseengine.h"
#include "oodwaitabusyindicatordata.h"
...
class OODWAITAQT_EXPORT BusyIndicatorEngine : public BaseEngine
{
    Q_OBJECT
...
#endif // OODWAITA_BUSY_INDICATOR_ENGINE_H
