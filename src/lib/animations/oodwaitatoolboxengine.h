...
#ifndef OODWAITA_TOOLBOX_ENGINE_H
#define OODWAITA_TOOLBOX_ENGINE_H
...
class OODWAITAQT_EXPORT ToolBoxEngine : public BaseEngine
{
    Q_OBJECT
...
#endif // OODWAITA_TOOLBOX_ENGINE_H
