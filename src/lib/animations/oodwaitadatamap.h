...
#ifndef OODWAITA_DATAMAP_H
#define OODWAITA_DATAMAP_H
...
template<typename K, typename T> class OODWAITAQT_EXPORT BaseDataMap : public QMap<const K *, WeakPointer<T>>
{
public:
    using Key = const K *;
...
template<typename T> class OODWAITAQT_EXPORT DataMap : public BaseDataMap<QObject, T>
{
public:
    //* constructor
    DataMap()
...
template<typename T> class OODWAITAQT_EXPORT PaintDeviceDataMap : public BaseDataMap<QPaintDevice, T>
{
public:
    //* constructor
    PaintDeviceDataMap()
