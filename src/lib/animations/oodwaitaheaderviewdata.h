...
#ifndef OODWAITA_HEADER_VIEW_DATA_H
#define OODWAITA_HEADER_VIEW_DATA_H
...
{
//* headerviews
class OODWAITAQT_EXPORT HeaderViewData : public AnimationData
{
    Q_OBJECT
...
#endif // OODWAITA_HEADER_VIEW_DATA_H
