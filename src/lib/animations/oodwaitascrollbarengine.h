...
#ifndef OODWAITA_SCROLLBAR_ENGINE_H
#define OODWAITA_SCROLLBAR_ENGINE_H

#include "oodwaitascrollbardata.h"
...
class OODWAITAQT_EXPORT ScrollBarEngine : public WidgetStateEngine
{
    Q_OBJECT
...
#endif // OODWAITA_SCROLLBAR_ENGINE_H
