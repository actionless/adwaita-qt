...
#ifndef OODWAITA_DIAL_ENGINE_H
#define OODWAITA_DIAL_ENGINE_H

#include "oodwaitadialdata.h"
...
class OODWAITAQT_EXPORT DialEngine : public WidgetStateEngine
{
    Q_OBJECT
public:
    //* constructor
