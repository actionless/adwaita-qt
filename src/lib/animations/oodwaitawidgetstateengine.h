...
#ifndef OODWAITA_WIDGET_STATE_ENGINE_H
#define OODWAITA_WIDGET_STATE_ENGINE_H
...
class OODWAITAQT_EXPORT WidgetStateEngine : public BaseEngine
{
    Q_OBJECT
public:
    //* constructor
...
#endif // OODWAITA_WIDGET_STATE_ENGINE_H
