...
#ifndef OODWAITA_HEADER_VIEW_ENGINE_H
#define OODWAITA_HEADER_VIEW_ENGINE_H

#include "oodwaitabaseengine.h"
#include "oodwaitadatamap.h"
#include "oodwaitaheaderviewdata.h"
#include "oodwaitaqt_export.h"

namespace Oodwaita
{
//* stores headerview hovered action and timeLine
class OODWAITAQT_EXPORT HeaderViewEngine : public BaseEngine
{
    Q_OBJECT
public:
    //* constructor
...
#endif // OODWAITA_HEADER_VIEW_ENGINE_H
