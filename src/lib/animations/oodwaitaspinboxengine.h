...
#ifndef OODWAITA_SPINBOX_ENGINE_H
#define OODWAITA_SPINBOX_ENGINE_H

#include "oodwaitabaseengine.h"
#include "oodwaitadatamap.h"
#include "oodwaitaspinboxdata.h"
#include "oodwaitaqt_export.h"

namespace Oodwaita
{
//* handle spinbox arrows hover effect
class OODWAITAQT_EXPORT SpinBoxEngine : public BaseEngine
{
    Q_OBJECT
public:
    //* constructor
...
#endif // OODWAITA_SPINBOX_ENGINE_H
