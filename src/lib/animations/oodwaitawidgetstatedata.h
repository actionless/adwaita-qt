...
#ifndef OODWAITA_WIDGET_STATE_DATA_H
#define OODWAITA_WIDGET_STATE_DATA_H

#include "oodwaitagenericdata.h"
#include "oodwaitaqt_export.h"

namespace Oodwaita
{
//* handle widget state (hover/focus/enable) changes
class OODWAITAQT_EXPORT WidgetStateData : public GenericData
{
    Q_OBJECT
public:
    //* constructor
...
#endif // OODWAITA_WIDGET_STATE_DATA_H
