...
{
    // animation steps
    AnimationData::setSteps(Oodwaita::Config::AnimationSteps);

    bool animationsEnabled(Oodwaita::Config::AnimationsEnabled);
    int animationsDuration(Oodwaita::Config::AnimationsDuration);
    ...
    _stackedWidgetEngine->setEnabled(animationsEnabled && Oodwaita::Config::StackedWidgetTransitionsEnabled);

    // busy indicator
    _busyIndicatorEngine->setEnabled(Oodwaita::Config::ProgressBarAnimated);
    _busyIndicatorEngine->setDuration(Oodwaita::Config::ProgressBarBusyStepDuration);
}
